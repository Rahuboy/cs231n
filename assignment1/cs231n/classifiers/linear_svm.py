...
def svm_loss_naive(W, X, y, reg):
    ...
    for i in range(num_train):
        ...
        for j in range(num_classes):
            ...
            if margin > 0:
                loss += margin
                margin_counter += 1 #added by me
                dL[:,j] = X[i].T #added by me
        dL[:, y[i]] = -1*margin_counter*X[i].T #added by me
        dW += dL / X.shape[0] #added by me
...
def svm_loss_vectorized(W, X, y, reg):
    ...
    # *****END OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
    # print(f'vectorized gradient is {dW}')
